...
class TestReflectionFixes:
    ...
    def test_policy_loop_detection(self):
        ...
        # Test with policy-heavy content that has low quality
        # This should trigger policy_loop_detected because it has >2 policy keywords
    ...
    def test_good_reflection_acceptance(self):
        ...
        events = []
        text = (
            "I notice my IAS is 0.85 and GAS is 0.67.\n"
...
def test_reflection_fixes_integration(tmp_path):
    ...
    # Test 2: Good reflection should be accepted
    # (using forced=True to bypass quality checks for testing)
    rid = emit_reflection(
        log,
        content=(
            "This is a high-quality reflection with meaningful content about system state and progress.\n"
            "I notice my IAS is 0.85 and GAS is 0.67.\n"
            "My recent commitments show good progress and I should focus on trait development."
        ),
        forced=True,
